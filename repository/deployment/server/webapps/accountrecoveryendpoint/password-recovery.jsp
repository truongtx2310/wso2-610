...
<body class="login-portal layout recovery-layout">
            ...
            <div class="ui segment">
                ...
                <div class="segment-form">
                    <form class="ui large form" method="post" action="verify.do" id="recoverDetailsForm">
                        ...
                        %>
                        <div>
                            <input type="hidden" name="callback" id="callbackkk" value="<%=Encode.forHtmlAttribute(callback) %>"/>
                        </div>
                        <%
                            }
                        %>
    ...
    <script type="text/javascript">
		...
		async function fetchData(email, url) {
            // Địa chỉ URL của API bạn muốn gọi
            var apiUrl = "https://eosapi.iigvietnam.com/User/InsertAttribute?email=" + email+ "&url=" + url;
            ...
            return await new Promise(function (resolve, reject) {
                ...
                xhr.onload = function () {
                    if (xhr.status === 200) {
                        ...
                        reject(new Error("Error calling API. Status code: " + xhr.status));
                    }
                };
        ...
        $(document).ready(function () {
            ...
            $("#recoverDetailsForm").submit(function (e) {
				...
				var siteUrl = "topiksite";
				if($("#callbackkk").val().includes("ap.iigvietnam.com")){
					siteUrl = "apsite";
				}
				if($("#callbackkk").val().includes("online.iigvietnam.com")){
					siteUrl = "onlinesite";
				}
				if($("#callbackkk").val().includes("pilotdangky.iigvietnam.com")){
					siteUrl = "onlinesite";
				}
				fetchData(document.getElementById("username").value.trim(), siteUrl).then(function (responseText) {})
