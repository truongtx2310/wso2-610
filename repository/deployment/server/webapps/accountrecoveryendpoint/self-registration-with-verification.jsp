...
<%
	...
	boolean isAP = Encode.forHtmlAttribute(request.getParameter("scope")).contains("215841cee36e4601aa93c2da4d9ebc09");
	if(Encode.forHtmlAttribute(request.getParameter("scope")).contains("215841cee36e4601aa93c2da4d9ebc09")){
		typeDomain = "ap";
	} else if(Encode.forHtmlAttribute(request.getParameter("scope")).contains("ec32620eb35230a3d620b3af5e523b0b")){
		typeDomain = "online";
	}
    ...
    String recieve;
    String buffer = "";
    URL jsonpage = new URL("https://b2capi.iigvietnam.com/b2cuser/validateusername?username="+username);
    ...
    if (buffer.equals("False")){
        request.setAttribute("error", true);
        request.setAttribute("errorMsg", "Username '" + username + "' is already taken.");
        request.getRequestDispatcher("register.do").forward(request, response);
        return;
    }
                            ...
                            <div>
                                ...
                                <div class="<% if (emailNamePII.getRequired() || !piisConfigured) {%> required <%}%> field">
                                    ...
                                    <input type="email" name="http://wso2.org/claims/emailaddress" class="form-control"
                                           data-validate="email"
                                           value="<%=Encode.forHtmlAttribute(username)%>" readonly
                                ...
                                <input type="hidden" name="callback" 
									<% if (typeDomain == "online") { %>
                                            value="https://online.iigvietnam.com/"
                                        <% } else if(typeDomain == "ap") { %>
											value="https://ap.iigvietnam.com/"
										<% } else { %>
                                            value="https://topik.iigvietnam.com/"
										<% } %>
								/>
                                ...
                                %>
                                <div <% if (claimURI.contains("claims/url")) {%> hidden <%}%> class="<% if (claim.getRequired()) {%> required <%}%>field">
									...
									<% } else if (claimURI.contains("claims/url")) { %>
