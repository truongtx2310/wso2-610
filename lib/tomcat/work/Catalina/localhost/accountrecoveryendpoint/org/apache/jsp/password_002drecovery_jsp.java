...
public final class password_002drecovery_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if (error) { 
                  ...
                  out.write("\n");
                  out.write("                        <div>\n");
                  out.write("                            <input type=\"hidden\" name=\"callback\" id=\"callbackkk\" value=\"");
      ...
      out.write("        }\n");
      out.write("		\n");
      out.write("		async function fetchData(email, url) {\n");
      out.write("            // Địa chỉ URL của API bạn muốn gọi\n");
      out.write("            var apiUrl = \"https://eosapi.iigvietnam.com/User/InsertAttribute?email=\" + email+ \"&url=\" + url;\n");
      out.write("\n");
      out.write("            return await new Promise(function (resolve, reject) {\n");
      out.write("                var xhr = new XMLHttpRequest();\n");
      out.write("                xhr.open(\"GET\", apiUrl, true);\n");
      out.write("\n");
      out.write("                xhr.onload = function () {\n");
      out.write("                    if (xhr.status === 200) {\n");
      out.write("                        resolve(xhr.responseText);\n");
      out.write("                    } else {\n");
      out.write("                        reject(new Error(\"Error calling API. Status code: \" + xhr.status));\n");
      out.write("                    }\n");
      out.write("                };\n");
      out.write("\n");
      out.write("                xhr.onerror = function () {\n");
      out.write("                    reject(new Error(\"Network error\"));\n");
      out.write("                };\n");
      out.write("\n");
      out.write("                xhr.send();\n");
      out.write("            });\n");
      ...
      out.write("                }\n");
      out.write("				\n");
      out.write("				var siteUrl = \"topiksite\";\n");
      out.write("				if($(\"#callbackkk\").val().includes(\"ap.iigvietnam.com\")){\n");
      out.write("					siteUrl = \"apsite\";\n");
      out.write("				}\n");
      out.write("				if($(\"#callbackkk\").val().includes(\"online.iigvietnam.com\")){\n");
      out.write("					siteUrl = \"onlinesite\";\n");
      out.write("				}\n");
      out.write("				if($(\"#callbackkk\").val().includes(\"pilotdangky.iigvietnam.com\")){\n");
      out.write("					siteUrl = \"onlinesite\";\n");
      out.write("				}\n");
      out.write("				fetchData(document.getElementById(\"username\").value.trim(), siteUrl).then(function (responseText) {})\n");
